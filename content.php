...
// jika user sudah login, maka jalankan perintah untuk pemanggilan file halaman konten
	...
	// jika halaman konten yang dipilih obat masuk, panggil file view obat masuk
	elseif ($_GET['module'] == 'pemasok') {
		include "modules/pemasok/view.php";
	}

	// jika halaman konten yang dipilih form obat keluar, panggil file form obat keluar
	elseif ($_GET['module'] == 'form_pemasok') {
		include "modules/pemasok/form.php";
	}
	// -----------------------------------------------------------------------------

	// jika halaman konten yang dipilih obat masuk, panggil file view obat masuk
	elseif ($_GET['module'] == 'kartu_stok') {
		include "modules/kartu-stok/view.php";
	}

	// jika halaman konten yang dipilih form obat keluar, panggil file form obat keluar
	elseif ($_GET['module'] == 'form_kartu_stok') {
		include "modules/kartu-stok/form.php";
	}
	// -----------------------------------------------------------------------------
