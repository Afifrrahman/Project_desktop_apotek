...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
	...
	if ($_GET["module"]=="pemasok" || $_GET["module"]=="form_pemasok") { ?>
		<li class="active">
		<a href="?module=pemasok"><i class="fa fa-cube"></i> Pemasok </a>
		</li>
	<?php
	}
	...
	if ($_GET["module"]=="obat_masuk") { ?>
		<li class="active treeview">
          	<a href="javascript:void(0);">
            	<i class="fa fa-exchange"></i> <span>Transaksi</span> <i class="fa fa-angle-left pull-right"></i>
          	</a>
      		<ul class="treeview-menu">
        		<li class="active"><a href="?module=obat_masuk"><i class="fa fa-circle-o"></i> Obat Masuk </a></li>
        		<li><a href="?module=obat_keluar"><i class="fa fa-circle-o"></i> Obat Keluar </a></li>
      		</ul>
    	</li>
    <?php
	}
	...
	elseif ($_GET["module"]=="obat_keluar") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		<li><a href="?module=obat_masuk"><i class="fa fa-circle-o"></i> Obat Masuk </a></li>
        		<li class="active"><a href="?module=obat_keluar"><i class="fa fa-circle-o"></i> Obat Keluar </a></li>
      		</ul>
    	</li>
    <?php
	}
