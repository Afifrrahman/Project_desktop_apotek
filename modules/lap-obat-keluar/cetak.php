    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='155' height='13' align='center' valign='middle'>$data[nama_obat]</td>
                        <td style='padding-right:10px;' width='80' height='13' align='center' valign='middle'>$data[jumlah_keluar]</td>
