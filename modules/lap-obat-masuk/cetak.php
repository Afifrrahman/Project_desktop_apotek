            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">PEMASOK</th>
                    </tr>
                </thead>
                <tbody>
<?php
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='155' align='center' height='13' valign='middle'>$data[nama_obat]</td>
                        <td style='padding-right:10px;' width='80' height='13' align='center' valign='middle'>$data[jumlah_masuk]</td>
                        <td width='80' height='13' align='center' valign='middle'>$data[satuan]</td>
                        <td width='80' height='13' align='center' valign='middle'>$pemasok[0]</td>
                    </tr>";
            $no++;
        }
    }
?>	
            ...
            <div id="footer-tanggal">
                Padang, <?php echo tgl_eng_to_ind("$hari_ini"); ?>
            </div>
