...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-in icon-title"></i> Transaksi Obat Masuk
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.kode_obat,a.jumlah_masuk,b.kode_obat,b.nama_obat,b.satuan, a.pemasok
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              $pemasok = $mysqli->query("select nama_pemasok from is_pemasok where kode_pemasok='$data[pemasok]'");
              $pemasok = $pemasok->fetch_row();
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$pemasok[0]</td>
            ...
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/obat-masuk/proses.php?act=delete&id=<?php echo $data['kode_obat'];?>" onclick="return confirm('Anda yakin ingin menghapus obat <?php echo $data['nama_obat']; ?> ?');">
