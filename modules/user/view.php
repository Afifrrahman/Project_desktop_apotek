            ...
            // menampilkan isi tabel dari database ke tabel di aplikasi
              ...
              echo "  <td>$data[username]</td>
                      ...
                      <td class='center' width='100'>
                          ...
                          ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/user/proses.php?act=delete&id=<?php echo $data['id_user'];?>" onclick="return confirm('Anda yakin ingin menghapus obat <?php echo $data['nama_user']; ?> ?');">
